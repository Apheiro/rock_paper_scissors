...
const content1 = document.querySelector("#computerVar");
const content2 = document.querySelector("#humanVar");
const content3 = document.querySelector("#gameItems");
...
function animation() {
    ...
    btn.forEach(button => button.style = "pointer-events: none;")
    setTimeout(() => {
    ...
    setTimeout(() => {
        ...
        btn.forEach(button => button.style = "pointer-events:;")
    }, 5500);
}
...
function game(humanSelection, computerPlaySelec) {
    ...
    if (humanPoints == 5) {
        setTimeout(() => [content1, content2, content3].forEach(content => content.classList.add('deleteAnimation')), 2100)
        setTimeout(() => [content1, content2, content3].forEach(content => content.style = 'display: none ;'), 2900)
        setTimeout(() => {
...
function removeClass(e) {
    ...
    if (this.id == "announcer") {announcer.textContent = "Select";}
}
